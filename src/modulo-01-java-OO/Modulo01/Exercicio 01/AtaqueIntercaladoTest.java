...
/**
 * The test class AtaqueIntercaladoTest.
 *
 * @author  (your name)
...
public class AtaqueIntercaladoTest
{
    ...
    public void test5ElfosVerdes5ElfosNoturnosAtacam1Dwarf() {
       ...
       assertEquals("N,V,N,V,N,V,N,V,N,V,", exercito.getEstrategia().getOrdemDoUltimoAtaque());
    }
    
    @Test
    public void test4ElfosVerdes6ElfosNoturnosAtacam1DwarfNoturnoAtacaPrimeiro() {
        ExercitoDeElfos exercito = new ExercitoDeElfos();
        exercito.mudarEstrategia(new AtaqueIntercalado());
        Elfo a = new ElfoVerde("A");
        Elfo b = new ElfoVerde("B");
       ...
       exercito.atacar(dwarves);       
       assertEquals(30, dwarf1.getVida());
       assertEquals("N,V,N,V,N,V,N,V,", exercito.getEstrategia().getOrdemDoUltimoAtaque());
    }
    
    @Test
    public void test3ElfosVerdes7ElfosNoturnos1MortoAtacam3DwarfVerdeAtacaPrimeiro() {
        ExercitoDeElfos exercito = new ExercitoDeElfos();
        exercito.mudarEstrategia(new AtaqueIntercalado());
        Elfo a = new ElfoNoturno("A");
        Elfo b = new ElfoNoturno("B");
        Elfo c = new ElfoNoturno("C");
        Elfo d = new ElfoNoturno("D");
        Elfo e = new ElfoNoturno("E");
        Elfo noturno1 = new ElfoVerde("A1");
        Elfo noturno2 = new ElfoVerde("A2");
        Elfo noturno3 = new ElfoVerde("A3");
        Elfo noturno4 = new ElfoNoturno("A4");
        Elfo noturno5 = new ElfoNoturno("A5");
       ...
       exercito.atacar(dwarves);       
       assertEquals(50, dwarf1.getVida());
       assertEquals(50, dwarf2.getVida());
       assertEquals(50, dwarf3.getVida());
       assertEquals("V,N,V,N,V,N,V,N,V,N,V,N,V,N,V,N,V,N,", exercito.getEstrategia().getOrdemDoUltimoAtaque());
    }
}
